%% Calcule les grandeurs globales et leur évolution temporelle (Cmoy, Cstd...) avec l'hypothèse d'absorption linéaire par les glass bubbles.
fprintf('Video ');
...
dispstat(sprintf('Begining the process for the movie with linear method...'),'keepthis','timestamp');
...
Cstd=sqrt(C2Moy - CMoy.^2); %#ok<NASGU>
CstdSq=sqrt(C2MoySq - CMoySq.^2); %#ok<NASGU>





save(strcat(directoryAnalyse,'Conclin2.mat'),'time','CMoy','C2Moy','Cstd','CMoySq','C2MoySq','CstdSq')
