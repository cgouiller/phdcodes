...
% setCatalogue{51}='varSize';setCatalogue{52}='varSize';setCatalogue{53}='manip1';setCatalogue{54}='pics';setCatalogue{55}='rosaces';
% 
% %Name of the folders
...
% actCatalogue{51}='actif';actCatalogue{52}='actif';actCatalogue{53}='actif';actCatalogue{54}='actif';actCatalogue{55}='actif';
% 
% 
...
videoCatalogue{51}='300';videoCatalogue{52}='600';
    ...
    AmpVortex=[AmpVortex,str2num(videoCatalogue{numVid})];
end
save('E:\Clément\MyCore\Analyse\Multi\manips.mat','Nombre','AmpVortex','Date','Set','Rayon','Video','Act','Raystr')
>>>>>>> essaispivnappe
