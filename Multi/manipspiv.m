...
dateCatalogue{1}='200728\';dateCatalogue{2}='200728\';dateCatalogue{3}='200728\';%dateCatalogue{4}='200603\';dateCatalogue{5}='200603\';dateCatalogue{6}='200603\';dateCatalogue{7}='200603\';dateCatalogue{8}='200603\';dateCatalogue{9}='200603\';dateCatalogue{10}='200603\';
...
setCatalogue{1}='fin_avec_mur\';setCatalogue{2}='fin_sans_mur\';setCatalogue{3}='large_sans_mur\';%setCatalogue{4}='actif\';setCatalogue{5}='actif\';setCatalogue{6}='actif\';setCatalogue{7}='actif\';setCatalogue{8}='actif\';setCatalogue{9}='actif\';setCatalogue{10}='actif\';
...
videoCatalogue{1}='';videoCatalogue{2}='';videoCatalogue{3}='';%videoCatalogue{4}='150\';videoCatalogue{5}='180\';videoCatalogue{6}='240\';videoCatalogue{7}='300\';videoCatalogue{8}='360\';videoCatalogue{9}='450\';videoCatalogue{10}='600\';
...
RCat=[NaN;NaN;NaN]/2;
Rdetect=[NaN;NaN;NaN]/2;
    

startImgCatalogue=[360;370;483];
hgxcat=[257;370;112]; % Coord x du coin en haut à gauche
hgycat=[309;251;120]; % Coord y du coin en haut à gauche
hdxcat=[1711;1840;1954]; % x haut droite
hdycat=[298;277;120]; % y haut droite
bdxcat=[1733;1822;1962]; % x bas gauche
bdycat=[1759;1740;1949]; % y bas gauche
bgxcat=[248;350;118]; % x bas droit
bgycat=[1777;1722;1962]; % y bas droit
...
centerXCat=(hgxcat+hdxcat+bgxcat+bdxcat)/4;
centerYCat=(hgycat+hdycat+bgycat+bdycat)/4;
