...
dateCatalogue{1}='200728\';dateCatalogue{2}='200728\';dateCatalogue{3}='200728\';dateCatalogue{4}='200915\';dateCatalogue{5}='200915\';dateCatalogue{6}='200915\';dateCatalogue{7}='200915\';dateCatalogue{8}='200917\';dateCatalogue{9}='200917\';%dateCatalogue{10}='200603\';
...
setCatalogue{1}='fin_avec_mur\';setCatalogue{2}='fin_sans_mur\';setCatalogue{3}='large_sans_mur\';setCatalogue{4}='geom\';setCatalogue{5}='essai1\';setCatalogue{6}='essai2\';setCatalogue{7}='essai3\';setCatalogue{8}='piv\';setCatalogue{9}='piv\';%setCatalogue{10}='actif\';
...
videoCatalogue{1}='';videoCatalogue{2}='';videoCatalogue{3}='';videoCatalogue{4}='';videoCatalogue{5}='';videoCatalogue{6}='';videoCatalogue{7}='';videoCatalogue{8}='exp1';videoCatalogue{9}='exp2';%videoCatalogue{10}='600\';
...
startImgCatalogue=[360;370;483;1;1;1;1;1;1];
hgxcat=[257;370;112;65;308;307;305;246;310]; % Coord x du coin en haut à gauche
hgycat=[309;251;120;401;245;239;239;233;191]; % Coord y du coin en haut à gauche
hdxcat=[1711;1840;1954;1587;1866;1865;1863;1817;1882]; % x haut droite
hdycat=[298;277;120;54;266;260;259;221;196]; % y haut droite
bdxcat=[1733;1822;1962;1937;1851;1850;1848;1835;1881]; % x bas gauche
bdycat=[1759;1740;1949;1573;1825;1819;1817;1785;1759]; % y bas gauche
bgxcat=[248;350;118;423;295;294;292;260;313]; % x bas droit
bgycat=[1777;1722;1962;1929;1815;1808;1807;1807;1763]; % y bas droit
...
trueCarre=[96.4,96.4,120.5,96.4,96.4,96.4,96.4,96.4,96.4];
