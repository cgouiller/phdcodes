...
basePathVidCatalogue{81}='H:\Multi\';basePathVidCatalogue{82}='H:\Multi\';basePathVidCatalogue{83}='H:\Multi\';basePathVidCatalogue{84}='H:\Multi\';basePathVidCatalogue{85}='H:\Multi\';basePathVidCatalogue{86}='I:\Multi\';
...
%fps of the videos
fpscat=[30*ones(1,52),27.8,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10];
...
dateCatalogue{81}='210111';dateCatalogue{82}='210111';dateCatalogue{83}='210111';dateCatalogue{84}='210112';dateCatalogue{85}='210112';dateCatalogue{86}='210112';
...
setCatalogue{81}='pics';setCatalogue{82}='pics';setCatalogue{83}='pics';setCatalogue{84}='pics';setCatalogue{85}='pics';setCatalogue{86}='pics';
...
actCatalogue{81}='actif';actCatalogue{82}='actif';actCatalogue{83}='actif';actCatalogue{84}='actif';actCatalogue{85}='actif';actCatalogue{86}='actif';
...
videoCatalogue{81}='110_1';videoCatalogue{82}='110_2';videoCatalogue{83}='110_3';videoCatalogue{84}='90_1';videoCatalogue{85}='90_2';videoCatalogue{86}='90_3';
...
calibCat=[120.5./coteCarre(1:52),96.4/coteCarre(53),106.3/coteCarre(54),107/coteCarre(55),96.4/1339.5,96.4/1340,96.4/1340,96.4/1346,96.4/1344,96.4/1345,101.4/1415,101.4/1415,101.4/1414,101.4/1409,101.4/1409,101.4/1409,96.4/1342,96.4/1338,96.4/1340,96.4/1339,96.4/1340,96.4/1341,96.4/1340,96.4/1341,96.4/1339,96.4/1338,96.4/1340,96.4/1338,96.4/1339,96.4/1339,96.4/1339,96.4/1339,96.4/1339,96.4/1338,96.4/1339]; %120.5 mm est le côté du carré
