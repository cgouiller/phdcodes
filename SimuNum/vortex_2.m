...
%% Calcul du spectre du champ de vitesse
    ...
    %% On sauvegarde tout
    save(strcat('E:\Clément\SimuNum\Resultats\200318',num2str(amp_ec)),'ma','mx','my','muxp','muyp','mvsx','mvsy','npart','Dnag','inertie','taup','marangoni','asrc','advection','ecoulement','param_ecexterne','amp_ec','mvfx','mvfy','f','Spx','Spy')
