...
Duree=[];
run manips.m
for i=1:length(manipCat200320.A)
    if i==22
    ...
    directoryPyt=strcat('E:\Clément\MyCore\Analyse\SimuNum\Vortex\200320\',manipCat200320.set{i},'\');
    mkdir(directoryPyt);
    k=f;
    save(strcat(directoryPyt,manipCat200320.video{i},'.mat'),'mx','my','k','Spx','Spy','dt','mamsd','Ec','tracks','countx','county','countax','countay','bin')
