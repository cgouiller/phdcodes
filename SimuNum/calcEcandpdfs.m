...
save(strcat('E:\Clément\SimuNum\Resultats\v2N',num2str(varN(i)),'ampec',num2str(varec(ii)),'_analyze.mat'),'dt','Ec','tracks','countx','county','countax','countay','binx','biny','binax','binay')
